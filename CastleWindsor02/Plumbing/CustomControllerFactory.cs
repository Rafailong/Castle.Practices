...
// </copyright>
// <summary>
//   Custom Factory to Inject Controller Dependencies.
// </summary>
// --------------------------------------------------------------------------------------------------------------------

namespace CastleWindsor02.Plumbing
{
    using System;
    using System.Web;
    ...
    /// <summary>
    /// Custom Factory to Inject Controller Dependencies.
    /// We create this custom becaus the Controller from the app
    /// gonna need some os their Dependencies to be Injected.
    /// </summary>
    public class CustomControllerFactory : DefaultControllerFactory
    {
        /// <summary>
        /// Internal intance of IKernel.
        /// </summary>
